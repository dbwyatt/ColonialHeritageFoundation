"""
Django settings for ColonialHeritageFoundation project.
...
SECRET_KEY = 'gybk)cory%yk*8qnsevas%3^)h8$arq=t^#5@n%&cs$*yaxb7@'
...
ROOT_URLCONF = 'ColonialHeritageFoundation.urls'

WSGI_APPLICATION = 'ColonialHeritageFoundation.wsgi.application'
